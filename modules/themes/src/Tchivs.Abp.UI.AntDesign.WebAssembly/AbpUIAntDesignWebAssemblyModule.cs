...
namespace Tchivs.Abp.UI.AntDesign.WebAssembly
{
    [DependsOn(typeof(AbpUIAntDesignModule))]
    public class AbpUIAntDesignWebAssemblyModule : AbpAspNetCoreComponentsWebAssemblyBasicModule<AntDesignBundleContributor>
    {
