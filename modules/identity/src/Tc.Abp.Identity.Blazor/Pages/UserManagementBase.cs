...
using Tc.Abp.AspNetCore.PageToolbars;
...
namespace Tc.Abp.Identity.Blazor
{
    ...
    public abstract class UserManagementBase: TcAbpCrudPageBase<IIdentityUserAppService, IdentityUserDto, Guid, GetIdentityUsersInput, IdentityUserCreateDto, IdentityUserUpdateDto>
    {
        ...
        private List<TableColumn> UserManagementTableColumns => TableColumns.Get<UserManagementBase>();
        ...
        protected override ValueTask SetTableColumnsAsync()
        {
            UserManagementTableColumns
                .AddRange(new TableColumn[]
                {
                    ...
                    {
                        Title = L["Actions"],
                        Actions = EntityActions.Get<UserManagementBase>(),
                    },
                    new TableColumn
                    {
                        Title = L["UserName"],
